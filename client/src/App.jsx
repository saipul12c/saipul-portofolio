...
// Protected wrapper for /route-control
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route
            path="/pengembangan"
            element={<PengembanganWithUnlock duration={5000} />}
          />
          ...
          <Route
            path="/proyek"
            element={
              <GuardedRoute fallbackPath="/pengembangan" path="/proyek">
                <Proyek />
              </GuardedRoute>
            }
          />
          <Route
            path="/proyek/:slug"
            element={
              <GuardedRoute fallbackPath="/pengembangan" path="/proyek/:slug">
                <DetailProyek />
              </GuardedRoute>
            }
          />
          <Route
            path="/pendidikan"
            element={
              <GuardedRoute fallbackPath="/pengembangan" path="/pendidikan">
                <Pendidikan />
              </GuardedRoute>
            }
          />
          <Route
            path="/detail-proyek"
            element={
              <GuardedRoute fallbackPath="/pengembangan" path="/detail-proyek">
                <DetailProyek />
              </GuardedRoute>
            }
          />
          <Route
            path="/testimoni"
            element={
              <GuardedRoute fallbackPath="/pengembangan" path="/testimoni">
                <Testimoni />
              </GuardedRoute>
            }
          />
